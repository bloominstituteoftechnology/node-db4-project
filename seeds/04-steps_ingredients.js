...
exports.seed = function(knex, Promise) {
    return knex('steps_ingredients').insert([
      ...
      { step_id: 2, ingredient_id: 8 ,quantity: 1},
      { step_id: 2, ingredient_id: 9 ,quantity: 1},
      { step_id: 2, ingredient_id: 10 ,quantity: 1},
      { step_id: 2, ingredient_id: 11 ,quantity: 0.5},
      { step_id: 2, ingredient_id: 12 ,quantity: 1 },
      { step_id: 3, ingredient_id: 13 ,quantity: 0.5},
      { step_id: 4, ingredient_id: 14 ,quantity: 1},
      { step_id: 4, ingredient_id: 15 ,quantity: 0.5},
      { step_id: 2, ingredient_id: 16 ,quantity: 6},
    ]);
  };