...
const steps = [
    ...
    { step_text: 'Cook for 20 minutes', step_number: 3, recipe_id: 2 },

    { step_text: 'fish out salmon', step_number: 1, recipe_id: 3 },
    { step_text: 'add salmon to pan', step_number: 2, recipe_id: 3 },
]
