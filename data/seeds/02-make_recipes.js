...
const steps = [
    ...
    { step_text: 'Put chicken and lemon in over', step_number: 2, recipe_id: 3 },
    { step_text: 'Put in over at 450 degrees', step_number: 3, recipe_id: 3 },
    
    // Salmon en Papillote

    { step_text: 'Fish a salmon from the river', step_number: 1, recipe_id: 2 },
    { step_text: 'Cook salmon', step_number: 2, recipe_id: 2 },
