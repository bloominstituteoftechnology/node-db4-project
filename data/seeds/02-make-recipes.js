const recipes = [
    {recipe_name: `It's a Spicy, Meat-a-ball-a!`, created_at: new Date().toUTCString()},
    {recipe_name: 'Roasted Rosemary Cauliflower', created_at: new Date().toUTCString()},
    {recipe_name: 'Grilled Teriyaki Salmon', created_at: new Date().toUTCString()}
]
...
const steps = [
    // Chili and Jelly Meatballs
    {step_number: 1, step_instructions: 'Prepare meatballs according to package instructions.', recipe_id: 1},
    {
        step_number: 2,
        step_instructions: 'In a large skillet, combine chili sauce and jelly; cook and stir over medium heat until jelly has' +
            ' melted.',
        recipe_id: 1
    },
    {step_number: 3, step_instructions: 'Add meatballs to pan; heat through.', recipe_id: 1},
    // Roasted Rosemary Cauliflower
    {step_number: 1, step_instructions: 'Preheat oven to 450°.', recipe_id: 2},
    {
        step_number: 2,
        step_instructions: 'Toss together all ingredients; spread in a greased 15x10x1-in. pan.',
        recipe_id: 2
    },
    {
        step_number: 3,
        step_instructions: 'Roast until tender and lightly browned, 20-25 minutes, stirring occasionally.',
        recipe_id: 2
    },
    // Grilled Teriyaki Salmon
    {
        step_number: 1,
        step_instructions: 'In a small bowl, whisk teriyaki sauce and syrup. Pour 1 cup marinade into a large resealable' +
    ...
    {
        step_number: 2,
        step_instructions: 'Drain salmon, discarding marinade in bag. Moisten a paper towel with cooking oil; using' +
            ' long-handled tongs, rub on grill rack to coat lightly.',
        recipe_id: 3
    },
    {
        step_number: 3,
        step_instructions: 'Place salmon on grill rack, skin side down. Grill, covered, over medium heat or broil 4 in. from' +
