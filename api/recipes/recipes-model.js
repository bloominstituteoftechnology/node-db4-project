...
async function getRecipeById(recipe_id) {
    ...
    // Returning in shapes instead of just rows return recipeRows
    const recipes = {
        ...
        steps: recipeRows.reduce((acc, row) => {
            ...
            // Including Step we have encountered before like "add pesto mixed with pasta" but showing both ingredients
